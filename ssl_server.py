...
if __name__ == "__main__":
    ...
    open_distribution = DefaultTrainingInitOpenDistribution(
        ...
        lr_scheduler=CosineAnnealingLRScheduler(2000),
        model_key="simclr",
    ...
    instructions = [
        ...
        InitGlobalModelAction(model_key="simclr"),
    ...
    start_server(
        ...
        watcher=[BestModelSaverWatcher(model_key="simclr")],
        permanent_conditions=[RequireNumberOfClientsCondition(2)],
        run_name="pretraining_simclr_weak_5000",
